 ...
 * page, the PDP and checkout, and so a change to the return window is one edit.
 *
...
export const POLICIES: Record<string, Policy> = {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "If we decline it, or if we do not manage to review it within the review window, the handset is released and nothing is charged. You are welcome to apply again, or to buy it outright or with cash on delivery.",
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "An approved refund is returned by the method you paid with. Cash on delivery orders are refunded by bank transfer to an account in the orderer's name.",
  ...
  delivery: {
    slug: "delivery",
    title: "Delivery",
    summary: "Delivery cost and an estimated time range are shown before you place an order.",
    sections: [
      {
        heading: "Cost and timing",
        body: [
          "Standard delivery starts at Rs 200 within Karachi and Rs 250 to Rs 550 elsewhere depending on the destination.",
      ...
      },
      {
        ...
        body: [
          "Cash on delivery is available in most cities for orders up to Rs 150,000.",
          "We may call to confirm a cash on delivery order before dispatch.",
          "Cash on delivery is not available in Gilgit-Baltistan or Azad Jammu & Kashmir, where the return leg makes it impractical.",
        ],
      },
      {
        ...
        body: [
          ...
          "You receive a tracking number by email when your order ships.",
        ],
      },
    ],
  },
